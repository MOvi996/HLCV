...
class ConfigParser:
    def __init__(
        self, config, root_dir=None, resume=None, modification=None, run_id=None
    ):
        """
        ...
        save_dir = self._config["trainer"]["save_dir"]
    ...
    @classmethod
    def wo_args(cls, config, root_dir=None, resume=None, run_id=None):
        """
        ...
        return cls(config, root_dir, resume, None, run_id)
